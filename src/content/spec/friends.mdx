...
export const site = {
  ...
  github: "https://github.com/Bingak",
  email: "lonelybing@outlook.com",
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">点页面顶部的「申请友链」按钮填表提交</p>
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">表单通过 Cloudflare 人机验证后会自动向本站仓库提交一个 PR，站长合并后即上线喵~ 也可以复制下面的模板到评论区留言，或发送申请邮件至：<code class="px-1.5 py-0.5 rounded bg-black/5 dark:bg-white/10 text-[0.7rem]">{site.email}</code></p>
