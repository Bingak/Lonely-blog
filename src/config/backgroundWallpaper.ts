	...
	common: {
		...
		homeText: {
			...
			subtitle: [
				...
				"人生没有白走的路，每一步都算数。——李宗盛",
				"成长就是将你的哭声调成静音的过程。",
				"小时候摔倒了，要看周围有没有人，有就哭，没有就爬起来；长大后摔倒了，也要看周围有没有人，有就爬起来，没有就哭。",
			...
			links: [
				...
				},
				{
					...
					url: "mailto:LonelyBing@outlook.com",
				},
				{
					name: "Sponsor",
